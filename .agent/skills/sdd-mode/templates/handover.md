...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Como usar:
  1. Copie para SDD/handovers/handover_<MODULO>_<DATA>.md
     - Multi-fase: SDD/handovers/handover_<MODULO>_FASE_<X>_<DATA>.md
     - Operacional: SDD/handovers/handover_<OPERACAO>_<DATA>.md
     - Bootstrap inicial: SDD/handovers/handover_DISCOVERY_<DATA>.md
...
**Sessão anterior:** `SDD/handovers/handover_<...>.md` (se houver)
...
3. SDD/handovers/handover_<MODULO>_FASE_<X>_<DATA>.md (este arquivo — autoridade do estado prévio)
4. SDD/INDEX.md
5. SDD/modules/SPEC_<MODULO>.md §<seção_relevante>
6. SDD/plans/PLAN_<MODULO>.md §"Fase <X+1>"
7. SDD/plans/TASKS_<MODULO>.md §"Fase <X+1>" (T-<X+1>1..T-<X+1>N)
...
*Próximo handover esperado: `SDD/handovers/handover_<MODULO>_FASE_<X+1>_<DATA>.md`*
