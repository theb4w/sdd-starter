...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Como usar:
  1. Copie para SDD/modules/SPEC_<MODULO>.md
  ...
  - Crie também SDD/plans/PLAN_<MODULO>.md (multi-fase)
...
**Spec relacionadas:** `SDD/modules/SPEC_<X>.md`, `SDD/decisions/ADR-NNN-*.md`
...
<!-- Mínimo:
- Referência ao Architecture document: SDD/architecture.md §X
...
- [ ] Handover gerado (`SDD/handovers/handover_<MODULO>_<DATA>.md`)
...
*Manter sincronizado com `SDD/INDEX.md`.*
