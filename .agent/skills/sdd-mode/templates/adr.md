...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Como usar:
  1. Copie para SDD/decisions/ADR-NNN-<slug-em-kebab>.md
  2. NNN = próximo número disponível (consulte SDD/INDEX.md)
...
- Spec: `SDD/modules/SPEC_<X>.md`
- PLAN: `SDD/plans/PLAN_<X>.md`
- Discussão original: <URL de issue/PR/discussion>
- Documentação técnica: <URLs>

---

*Atualizar `SDD/INDEX.md` após mudança de status.*
