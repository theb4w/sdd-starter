...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Como usar:
  1. Copie para docs/<NOME_PROJETO>_Architecture.md
...
> Cada módulo tem uma SPEC. Tabela mantida em sincronia com `specs/SPEC_INDEX.md`.

| Módulo | Responsabilidade | SPEC | Status |
|---|---|---|---|
| Auth | OAuth + sessão | `specs/modules/SPEC_AUTH.md` | <status> |
| Sessions | Gestão de sessão | `specs/modules/SPEC_SESSIONS.md` | <status> |
| <módulo> | <responsabilidade> | <spec> | <status> |
...
*Manter sincronizado com `specs/SPEC_INDEX.md` e `AGENTS.md`.*
