...
═══════════════════════════════════════════════════════════════════════════════
  ...
  Como usar:
  1. Copie este arquivo para specs/plans/PLAN_<MODULO>.md
...
**Autor:** <nome>
**Data:** YYYY-MM-DD
**Spec base:** `specs/modules/SPEC_<MODULO>.md`
...
*Após GATE 1 aprovado, gerar `specs/plans/TASKS_<MODULO>.md`. Não escrever código antes.*
