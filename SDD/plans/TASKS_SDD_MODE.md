...
**Data:** 2026-08-25
**PLAN base:** `SDD/plans/PLAN_SDD_MODE.md`
...
| T-A5 | Perfis no workflow | `.agent/skills/sdd-mode/references/workflow.md` §2 → MOD | tabela de perfis + coluna Playbook |
...
| T-B4 | Templates story e design | `SDD/stories/`, `SDD/design/` → NOVO | `_STORY_TEMPLATE.md`, `_DESIGN_TEMPLATE.md` |
...
| ID | Tarefa | Onde | AC |
|---|---|---|---|
| T-C1 | Prompts viram ponteiros | `sdd-mode playbooks (see .agent/skills/sdd-mode/playbooks/)*.md` → MOD | cada um cita o playbook; passos longos removidos ou reduzidos a checklist humano |
